...
#' the 15 most listened-to artists from the dataset `spotify_original`.
#' Details about such artists are available in Davila-Pena et al. (2024)
#' (Section 6.2, Table 11).
#'
#' @format A dataframe with 1226 rows (users) and 16 columns, one corresponding to the index number
#' (first column, `X`) and the remaining 15 corresponding to different artists.
#'
#' @docType data
#'
#' @usage data(spotify_15)
#'
#' @source
